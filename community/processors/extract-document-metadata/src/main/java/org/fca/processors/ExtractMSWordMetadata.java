...
public class ExtractMSWordMetadata extends ExtractTikaMetadata {

    public ExtractMSWordMetadata() {
    ...
    protected boolean isWordDocument(String mimetype) {
        ...
        switch (mimetype) {
            ...
            case "application/ms-word.document.macroEnabled.12":
            case "application/ms-word.template.macroEnabled.12":
