...
public class LanguageSttAudioRu implements Processor {

    private final static String sphinxdata = System.getenv("SPHINXDATA");
    private final static String acousticModel = new File(sphinxdata,"models/ru/acoustic").getAbsolutePath();
    private final static String dictionary = new File(sphinxdata,"models/ru/dictionary/ru.dic").getAbsolutePath();
    private final static String languageModel = new File(sphinxdata,"models/ru/language/ru.lm.bin").getAbsolutePath();

    public LanguageSttAudioRu() { }

    @Override
    public String getInputMicroFormatType() {
        return AudioContent.qualifiedMicroFormatType("ru");
    }

    @Override
    public List<String> getOutputMicroFormatTypes() {
        List<String> outputMicroFormatTypes = new ArrayList<>();
        outputMicroFormatTypes.add(TextContent.qualifiedMicroFormatType("ru"));
